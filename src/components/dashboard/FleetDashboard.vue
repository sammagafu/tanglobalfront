    ...
    <div class="py-4">
        <div class="col-12">
            ...
            <DataView :value="cargoData" :sortOrder="sortOrder" :sortField="sortField">
                <template #header>
                    <Dropdown v-model="sortField" :options="sortOptions" optionLabel="label" placeholder="Sort By"
                    ...
                    <div class="grid grid-nogutter">
                        <div v-for="(item, index) in slotProps.items" :key="index" class="">
                            <div class="flex flex-column sm:flex-row sm:align-items-center p-4 gap-3"
                                ...
                                <img v-if="item.images && item.images.length > 0" :src="item.images[0].image"
                                    class="block xl:block mx-auto rounded" :alt="item.platenumber" />
                                <div
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <div class="font-baseline font-medium flex flex-row">Fragile : {{
                                                item.fragile }}</div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <div class="font-baseline font-medium">Weight : {{ item.weight }} {{
                                                item.weight_unit }}</div>
                                            <div class="font-baseline font-medium">To : {{ item.destination }}</div>
                                            <div class="font-baseline font-medium">Temperature Sensitive : {{
                                    ...
                                    <div class="flex flex-column md:align-items-end gap-5">
                                        <div class="flex flex-row-reverse md:flex-row gap-2">
                                            <router-link :to="{ name: 'cargo-details', params: { uuid: item.uuid } }">
                                                <Button icon="pi pi-search" label="view" outlined
                                                    class="p-button-lg bg-blue-700 text-white px-4 py-2"></Button>
                                            </router-link>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-12 lg:col-5">
            ...
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert" v-for="update in updateData" :key="update.index">
                <router-link :to="{name:'update-details',params : {slug:update.slug}}"><strong class="font-bold">{{ update.name }}</strong></router-link>
            </div>
