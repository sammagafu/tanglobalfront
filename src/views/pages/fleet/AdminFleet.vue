    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card">
                    <DataView :value="fleet" :layout="layout">
                        <template #header>
                                    ...
                                    <div class="flex flex-column sm:flex-row sm:align-items-center p-4 gap-3"
                                        ...
                                        <div class="md:w-40 relative">
                                            <img v-if="item.images && item.images.length > 0"
                                                :src="item.images[0].image" class="block xl:block mx-auto rounded w-full"
                                                :alt="item.platenumber" />
                                            <img v-else src="https://via.placeholder.com/300"
                                                class="block xl:block mx-auto rounded w-full" alt="No Image Available" />
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <span
                                                        class="font-medium text-secondary text-sm">Car Plate Number</span>
                                                    <div class="text-lg font-medium text-900 mt-2">{{ item.platenumber }}
                                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="bg-surface-50 flex justify-center rounded p-4">
                                            <div class="relative mx-auto">
                                                <img class="rounded w-full"
                                                    :src="item.images && item.images.length > 0 ? item.images[0].image : 'https://via.placeholder.com/300'"
                                                    :alt="item.platenumber" style="max-width: 300px" />
                                        ...
                                        <div class="pt-6">
                                            <div class="flex flex-row justify-between items-start gap-2">
                                                <div>
                                                    <span
                                                        class="font-medium text-surface-500 dark:text-surface-400 text-sm">Car
                                                        Plate Number</span>
                                                    <div class="text-lg font-medium mt-1">{{ item.platenumber }}</div>
                                                    <div class="text-lg font-medium text-900">Carrying Capacity:
                                                        {{ item.capacity }} Tons</div>
                                                </div>
                                            </div>
